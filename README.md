...
| `DATABASE_URL` | `sqlite:///app/data/manager.db` | 🗄️ **数据库路径** - SQLite 数据库文件位置，一般无需修改 |
...
| `./data` | `/app/data` | ✅ | 💾 **持久化数据目录**<br>包含：<br>• `manager.db` - SQLite 数据库，存储脚本配置、调度设置等<br>• `logs/` - 脚本运行日志文件 |
